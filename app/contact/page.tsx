      ...
      <Container className="max-w-3xl">
        ...
        <div className="mt-5 grid gap-4 sm:grid-cols-2">
          <div className="rounded-2xl border border-line bg-white p-4 shadow-soft">
            ...
            <a href={whatsappUrl(suggestionMessage(), settings.whatsappNumber)} target="_blank" rel="noopener noreferrer" className="focus-ring mt-4 inline-flex h-11 items-center justify-center rounded-xl bg-primary px-4 text-sm font-semibold text-white shadow-crisp transition hover:bg-primaryDark">Message on WhatsApp</a>
          </div>
          <div className="rounded-2xl border border-line bg-white p-4 shadow-soft">
            ...
            <a className="mt-4 inline-block break-all text-sm font-semibold text-primary" href={`mailto:${settings.supportEmail}`}>{settings.supportEmail}</a>
          </div>
        </div>
      </Container>
    </section>
