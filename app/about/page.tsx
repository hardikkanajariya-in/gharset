    ...
    <section className="compact-section">
      <Container className="max-w-3xl">
        <div className="page-panel p-5 sm:p-6">
          <p className="text-xs font-semibold uppercase tracking-[0.16em] text-secondary">About</p>
          <h1 className="mt-2 text-[26px] font-semibold tracking-tight text-ink sm:text-[34px]">GharSet helps Indian homes stay organized with practical products.</h1>
