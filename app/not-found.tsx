  ...
  return (
    <section className="compact-section min-h-[62vh]">
      <Container className="max-w-3xl">
        <div className="overflow-hidden rounded-3xl border border-lineStrong bg-white shadow-lift">
          <div className="border-b border-line bg-primaryDark px-4 py-4 text-white sm:px-6">
            <div className="flex items-center justify-between gap-3">
              ...
              <div className="hidden h-12 w-12 items-center justify-center rounded-2xl border border-white/20 bg-white/[0.08] text-white sm:flex">
                <svg
                  viewBox="0 0 24 24"
                  className="h-5 w-5"
                  fill="none"
          ...
          <div className="px-4 py-5 sm:px-6">
            ...
            <div className="mt-5">
              ...
              <div className="mt-2 flex h-11 items-center rounded-xl border border-lineStrong bg-white px-3 transition focus-within:border-secondary focus-within:ring-2 focus-within:ring-secondary/15">
                <svg
                  viewBox="0 0 24 24"
              ...
              {filteredLinks.length > 0 ? (
                filteredLinks.map((item) => (
                  <Link
                    key={item.href}
                    href={item.href}
                    className="group rounded-2xl border border-line bg-white p-4 transition hover:border-secondary hover:shadow-soft"
                  >
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <span className="mt-0.5 text-sm text-muted transition group-hover:translate-x-0.5 group-hover:text-secondary">
                        →
                      </span>
                    </div>
                  </Link>
